...
const FloatingText = ({text}: {text: string}) => {
    ...
    const [position, setPosition] = useState({ top: Math.random() * maxHeight, left: Math.random() * maxWidth - 100 });
    const offsets = [-7000, -5000, -3000, -2000, -1000, 0, 1000, 3000, 5000, 7000]
...
const GhostDialogue = ({text, ...props}: DialogueProps) => {
    ...
    return <div>
        {floatingText.map((t, i) => <FloatingText key={i} text={t}/>)}
