  ...
  reducers: {
    ...
    incrementByAmount: (state, action: PayloadAction<number>) => {
        if (state.value) {
            ...
            localStorage.setItem(localIndex, (state.value + action.payload).toString())
          }
    },
...
export const { increment, decrement, incrementByAmount, setPlayerIndex, initializePlayerIndex } = counterSlice.actions
